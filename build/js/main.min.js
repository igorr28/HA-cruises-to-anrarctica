...
/* harmony import */ var _modules_burger_menu_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/burger-menu.js */ "./js/modules/burger-menu.js");
/* harmony import */ var _modules_form_validation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/form-validation */ "./js/modules/form-validation.js");
...
/* harmony import */ var _modules_mask_phone__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/mask-phone */ "./js/modules/mask-phone.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_burger_menu_js__WEBPACK_IMPORTED_MODULE_2__["initMainMenu"])();
  Object(_modules_form_validation__WEBPACK_IMPORTED_MODULE_3__["initFormValidation"])();
  Object(_modules_smooth_scroll__WEBPACK_IMPORTED_MODULE_5__["scrollTo"])();
  Object(_modules_map__WEBPACK_IMPORTED_MODULE_4__["initMap"])();
  Object(_modules_mask_phone__WEBPACK_IMPORTED_MODULE_6__["initMask"])();
...
/*!***********************************!*\
  !*** ./js/modules/burger-menu.js ***!
  \***********************************/
/*! exports provided: initMainMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initMainMenu", function() { return initMainMenu; });
...
var initMainMenu = function initMainMenu() {
  ...
  var buttonToogle = document.querySelector('[data-burger]');
  ...
  var onMenuKeydownEsc = function onMenuKeydownEsc(e) {
    var isEscKey = e.key === 'Escape' || e.key === 'Esc';
    if (isEscKey && header.classList.contains('is-menu-opened')) {
      e.preventDefault();
      closeMenu();
    }
  };
  var onClickMenuOut = function onClickMenuOut(e) {
    var target = e.target;
...
var showErrorElem = function showErrorElem(elem, message) {
  ...
  var parent = elem.closest('.form__row');
...
var CENTER_COORDS = [59.93897, 30.32385];
var MARKER_COORDS = [59.93856, 30.32266];
var DEFAULT_SCALE = 15;
var MARKER_SIZE = [18, 22];
var MARKER_OFSET = [-9, -22];
...
var initMap = function initMap() {
  ...
  function init() {
    ...
    // eslint-disable-next-line no-undef
    var myPlacemark = new ymaps.Placemark(MARKER_COORDS, {
...
var scrollTo = function scrollTo() {
  var smoothLinks = document.querySelectorAll('[data-scroll]');
